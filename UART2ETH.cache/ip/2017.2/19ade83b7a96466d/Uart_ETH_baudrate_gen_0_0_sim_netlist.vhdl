...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_baudrate_gen is
  port (
    ...
    o_Baud_16x_57600 : out STD_LOGIC;
    o_Baud_16x_115200 : out STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_baudrate_gen is
  ...
  signal \^o_baud_16x_115200\ : STD_LOGIC;
  signal o_Baud_16x_115200_i_1_n_0 : STD_LOGIC;
  signal \^o_baud_16x_57600\ : STD_LOGIC;
  signal o_Baud_16x_57600_i_1_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of o_Baud_16x_57600_i_1 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \s_counter_3B[0]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \s_counter_Free1[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \s_counter_Free1[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \s_counter_Free1[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \s_counter_Free1[4]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \s_counter_Free2[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \s_counter_Free2[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \s_counter_Free2[3]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \s_counter_Free2[4]_i_1\ : label is "soft_lutpair0";
...
o_Baud_16x_115200_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D1"
    )
        port map (
...
o_Baud_16x_115200_reg: unisim.vcomponents.FDRE
     port map (
      C => i_CLK,
      CE => '1',
...
o_Baud_16x_57600_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D1"
    )
        port map (
...
o_Baud_16x_57600_reg: unisim.vcomponents.FDRE
     port map (
      C => i_CLK,
      CE => '1',
