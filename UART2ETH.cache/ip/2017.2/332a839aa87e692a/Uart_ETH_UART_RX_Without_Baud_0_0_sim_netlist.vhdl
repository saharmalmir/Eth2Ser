...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_RX_Without_Baud is
  ...
  signal s_bit_count_1 : STD_LOGIC;
  ...
  signal \s_bit_count_reg[31]_i_6_n_2\ : STD_LOGIC;
  signal \s_bit_count_reg[31]_i_6_n_3\ : STD_LOGIC;
  signal \s_bit_count_reg[31]_i_6_n_5\ : STD_LOGIC;
  signal \s_bit_count_reg[31]_i_6_n_6\ : STD_LOGIC;
  signal \s_bit_count_reg[31]_i_6_n_7\ : STD_LOGIC;
  ...
  signal \NLW_s_bit_count_reg[31]_i_6_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_s_bit_count_reg[31]_i_6_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \s_Data[7]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of s_FrameEr_i_2 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of s_Valid_i_1 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \s_bit_count[2]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \s_bit_count[5]_i_1\ : label is "soft_lutpair1";
...
\s_Data[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => s_bit_count(0),
      I2 => \s_bit_count[31]_i_7_n_0\,
      I3 => \s_bit_count[31]_i_8_n_0\,
      I4 => \s_bit_count[31]_i_9_n_0\,
      I5 => s_bit_count(31),
      O => \s_Data[7]_i_2_n_0\
    );
...
s_FrameEr_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => s_RXD2,
      I1 => s_Baud_Edge_L,
      I2 => \s_Data[7]_i_2_n_0\,
      I3 => \s_bit_count[31]_i_3_n_0\,
      I4 => s_FrameEr_i_2_n_0,
      I5 => i_Reset,
      O => s_FrameEr_i_1_n_0
    );
s_FrameEr_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\s_bit_count[29]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => s_bit_count(1),
      I3 => \s_bit_count[31]_i_5_n_0\,
      I4 => \s_bit_count_reg[31]_i_6_n_7\,
      O => p_0_out(29)
    );
...
\s_bit_count[30]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => s_bit_count(1),
      I3 => \s_bit_count[31]_i_5_n_0\,
      I4 => \s_bit_count_reg[31]_i_6_n_6\,
      O => p_0_out(30)
    );
...
\s_bit_count[31]_i_2\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => s_bit_count(1),
      I3 => \s_bit_count[31]_i_5_n_0\,
      I4 => \s_bit_count_reg[31]_i_6_n_5\,
      O => p_0_out(31)
    );
\s_bit_count[31]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => \s_bit_count[31]_i_7_n_0\,
      I1 => \s_bit_count[31]_i_8_n_0\,
      I2 => \s_bit_count[31]_i_9_n_0\,
      I3 => s_bit_count(31),
      O => \s_bit_count[31]_i_3_n_0\
    );
\s_bit_count[31]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
      I0 => \s_bit_count[31]_i_9_n_0\,
      I1 => \s_bit_count[31]_i_8_n_0\,
      I2 => \s_bit_count[31]_i_7_n_0\,
...
\s_bit_count[31]_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\s_bit_count_reg[31]_i_6\: unisim.vcomponents.CARRY4
     port map (
      CI => \s_bit_count_reg[28]_i_2_n_0\,
      CO(3 downto 2) => \NLW_s_bit_count_reg[31]_i_6_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \s_bit_count_reg[31]_i_6_n_2\,
      CO(0) => \s_bit_count_reg[31]_i_6_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_s_bit_count_reg[31]_i_6_O_UNCONNECTED\(3),
      O(2) => \s_bit_count_reg[31]_i_6_n_5\,
      O(1) => \s_bit_count_reg[31]_i_6_n_6\,
      O(0) => \s_bit_count_reg[31]_i_6_n_7\,
      S(3) => '0',
      S(2) => \s_bit_count[31]_i_10_n_0\,
      S(1) => \s_bit_count[31]_i_11_n_0\,
      S(0) => \s_bit_count[31]_i_12_n_0\
    );
