...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_RX is
  ...
  signal \s_count[8]_i_6_n_0\ : STD_LOGIC;
  ...
  signal \s_count_reg[8]_i_2_n_0\ : STD_LOGIC;
  signal \s_count_reg[8]_i_2_n_1\ : STD_LOGIC;
  signal \s_count_reg[8]_i_2_n_2\ : STD_LOGIC;
  signal \s_count_reg[8]_i_2_n_3\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \s_count[5]_i_1\ : label is "soft_lutpair1";
...
\s_count[5]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0B"
    )
        port map (
...
\s_count[8]_i_6\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => s_count(5),
      O => \s_count[8]_i_6_n_0\
    );
...
\s_count_reg[8]_i_2\: unisim.vcomponents.CARRY4
     port map (
      CI => \s_count_reg[3]_i_1_n_0\,
      CO(3) => \s_count_reg[8]_i_2_n_0\,
      CO(2) => \s_count_reg[8]_i_2_n_1\,
      CO(1) => \s_count_reg[8]_i_2_n_2\,
      CO(0) => \s_count_reg[8]_i_2_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => s_count(8 downto 5),
      O(3 downto 0) => s_count0(8 downto 5),
      S(3) => \s_count[8]_i_3_n_0\,
      S(2) => \s_count[8]_i_4_n_0\,
      S(1) => \s_count[8]_i_5_n_0\,
      S(0) => \s_count[8]_i_6_n_0\
    );
