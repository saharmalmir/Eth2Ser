...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_TX is
  ...
  signal \s_BitTime_Counter[2]_i_2_n_0\ : STD_LOGIC;
  signal \s_BitTime_Counter[2]_i_3_n_0\ : STD_LOGIC;
  signal \s_BitTime_Counter[2]_i_4_n_0\ : STD_LOGIC;
  signal \s_BitTime_Counter[2]_i_5_n_0\ : STD_LOGIC;
  ...
  signal \s_BitTime_Counter_reg[2]_i_1_n_0\ : STD_LOGIC;
  signal \s_BitTime_Counter_reg[2]_i_1_n_1\ : STD_LOGIC;
  signal \s_BitTime_Counter_reg[2]_i_1_n_2\ : STD_LOGIC;
  signal \s_BitTime_Counter_reg[2]_i_1_n_3\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \s_BitTime_Counter[3]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \s_BitTime_Counter[4]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \s_BitTime_Counter[8]_i_1\ : label is "soft_lutpair8";
...
s_BitTime_Counter1_carry_i_2: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\s_BitTime_Counter[2]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\s_BitTime_Counter[2]_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\s_BitTime_Counter[2]_i_4\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\s_BitTime_Counter[2]_i_5\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\s_BitTime_Counter_reg[2]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \s_BitTime_Counter_reg[2]_i_1_n_0\,
      CO(2) => \s_BitTime_Counter_reg[2]_i_1_n_1\,
      CO(1) => \s_BitTime_Counter_reg[2]_i_1_n_2\,
      CO(0) => \s_BitTime_Counter_reg[2]_i_1_n_3\,
      CYINIT => \s_BitTime_Counter_reg_n_0_[0]\,
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => p_2_in(4 downto 1),
      S(3) => \s_BitTime_Counter[2]_i_2_n_0\,
      S(2) => \s_BitTime_Counter[2]_i_3_n_0\,
      S(1) => \s_BitTime_Counter[2]_i_4_n_0\,
      S(0) => \s_BitTime_Counter[2]_i_5_n_0\
    );
