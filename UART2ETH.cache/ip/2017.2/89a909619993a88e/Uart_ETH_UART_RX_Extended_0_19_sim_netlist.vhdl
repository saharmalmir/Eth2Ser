...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ Uart_ETH_UART_RX_Extended_0_19_sim_netlist.vhdl
-- Design      : Uart_ETH_UART_RX_Extended_0_19
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_RX_Extended is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_RX_Extended;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_RX_Extended is
  ...
  signal \FSM_onehot_s_Main_FSM[5]_i_8_n_0\ : STD_LOGIC;
  ...
  signal s_Parity_Rcvd_i_1_n_0 : STD_LOGIC;
  signal s_Parity_Rcvd_i_2_n_0 : STD_LOGIC;
  ...
  signal stop_bit_count : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \stop_bit_count[0]_i_1_n_0\ : STD_LOGIC;
  signal \stop_bit_count[1]_i_1_n_0\ : STD_LOGIC;
  signal \stop_bit_count[1]_i_2_n_0\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_onehot_s_Main_FSM[3]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \FSM_onehot_s_Main_FSM[4]_i_3\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of o_Error_i_1 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of o_Valid_i_1 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \rx_ticks[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \rx_ticks[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \rx_ticks[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \rx_ticks[3]_i_2\ : label is "soft_lutpair2";
  attribute XILINX_LEGACY_PRIM : string;
  attribute XILINX_LEGACY_PRIM of s_Parity_reg : label is "LD";
  attribute SOFT_HLUTNM of s_Parity_reg_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of s_Parity_reg_i_2 : label is "soft_lutpair0";
begin
  o_Data(7 downto 0) <= \^o_data\(7 downto 0);
  o_Error <= \^o_error\;
  o_Valid <= \^o_valid\;
\FSM_onehot_s_Main_FSM[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BABFAAAA"
    )
        port map (
      I0 => \FSM_onehot_s_Main_FSM[0]_i_2_n_0\,
      I1 => \FSM_onehot_s_Main_FSM[0]_i_3_n_0\,
      I2 => s_Main_FSM(4),
      I3 => \FSM_onehot_s_Main_FSM[5]_i_8_n_0\,
      I4 => \FSM_onehot_s_Main_FSM[5]_i_7_n_0\,
      O => \FSM_onehot_s_Main_FSM[0]_i_1_n_0\
    );
\FSM_onehot_s_Main_FSM[0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"8A"
    )
        port map (
...
\FSM_onehot_s_Main_FSM[0]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"777F555D"
    )
        port map (
...
\FSM_onehot_s_Main_FSM[4]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FF00FF0002FF0000"
    )
        port map (
      I0 => i_Stop_Bit(1),
      I1 => stop_bit_count(1),
...
\FSM_onehot_s_Main_FSM[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \FSM_onehot_s_Main_FSM[5]_i_5_n_0\,
      I3 => s_Main_FSM(1),
      I4 => \FSM_onehot_s_Main_FSM[5]_i_6_n_0\,
      I5 => i_Reset,
...
\FSM_onehot_s_Main_FSM[5]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \FSM_onehot_s_Main_FSM[5]_i_8_n_0\,
      I2 => s_Main_FSM(4),
      I3 => rx_clk_en,
      I4 => i_Stop_Bit(1),
      I5 => i_Stop_Bit(0),
...
\FSM_onehot_s_Main_FSM[5]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"22A2A2A2"
    )
        port map (
...
\FSM_onehot_s_Main_FSM[5]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\FSM_onehot_s_Main_FSM[5]_i_6\: unisim.vcomponents.LUT6
    generic map(
...
\FSM_onehot_s_Main_FSM[5]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\FSM_onehot_s_Main_FSM[5]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAA2AAA"
    )
        port map (
      ...
      I3 => rx_ticks(0),
      I4 => rx_ticks(3),
      O => \FSM_onehot_s_Main_FSM[5]_i_8_n_0\
    );
...
rx_clk_divider_en_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FB0A"
        ...
        port map (
      I0 => rx_clk_divider_en,
      I1 => s_Main_FSM(0),
      I2 => i_Reset,
      I3 => rx_clk_divider_en_reg_n_0,
      O => rx_clk_divider_en_i_1_n_0
    );
rx_clk_divider_en_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
s_Parity_Rcvd_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
      I0 => s_RXD2,
      I1 => s_Parity_Rcvd_i_2_n_0,
      I2 => s_Parity_Rcvd,
      O => s_Parity_Rcvd_i_1_n_0
    );
s_Parity_Rcvd_i_2: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => s_Main_FSM(2),
      I5 => i_Reset,
      O => s_Parity_Rcvd_i_2_n_0
    );
s_Parity_Rcvd_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
s_Parity_reg_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"2DD2D22D"
    )
        port map (
...
s_Parity_reg_i_3: unisim.vcomponents.LUT6
    generic map(
...
\stop_bit_count[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"15E0"
    )
        port map (
      I0 => s_Main_FSM(0),
      I1 => \stop_bit_count[1]_i_2_n_0\,
      I2 => s_Main_FSM(4),
      I3 => stop_bit_count(0),
      O => \stop_bit_count[0]_i_1_n_0\
    );
\stop_bit_count[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"5733A800"
    )
        port map (
      I0 => stop_bit_count(0),
      I1 => s_Main_FSM(0),
      I2 => \stop_bit_count[1]_i_2_n_0\,
      I3 => s_Main_FSM(4),
      I4 => stop_bit_count(1),
      O => \stop_bit_count[1]_i_1_n_0\
    );
\stop_bit_count[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => stop_bit_count(1),
      I5 => stop_bit_count(0),
      O => \stop_bit_count[1]_i_2_n_0\
    );
\stop_bit_count_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => i_CLK,
      CE => '1',
      D => \stop_bit_count[0]_i_1_n_0\,
      Q => stop_bit_count(0),
      R => i_Reset
    );
\stop_bit_count_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "Uart_ETH_UART_RX_Extended_0_19,UART_RX_Extended,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "UART_RX_Extended,Vivado 2017.2";
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
begin
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_RX_Extended
     port map (
      i_Baudx16 => i_Baudx16,
      i_CLK => i_CLK,
