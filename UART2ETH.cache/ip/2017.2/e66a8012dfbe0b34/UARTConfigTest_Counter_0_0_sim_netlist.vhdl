...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Counter is
  ...
  attribute SOFT_HLUTNM of \s_Count[0]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \s_Count[1]_i_1\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \s_Count[7]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \s_Tick_Counter[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \s_Tick_Counter[10]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \s_Tick_Counter[11]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \s_Tick_Counter[12]_i_1\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \s_Tick_Counter[15]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \s_Tick_Counter[2]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \s_Tick_Counter[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \s_Tick_Counter[4]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \s_Tick_Counter[5]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \s_Tick_Counter[6]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \s_Tick_Counter[7]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \s_Tick_Counter[8]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \s_Tick_Counter[9]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of s_Valid_i_3 : label is "soft_lutpair1";
begin
...
\s_Count[6]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"6AAAAAAA"
    )
        port map (
...
\s_Count[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \^o_count\(5),
      I2 => \^o_count\(3),
      I3 => \s_Count[7]_i_3_n_0\,
      I4 => \^o_count\(4),
      I5 => \^o_count\(6),
      O => plusOp(7)
    );
\s_Count[7]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
s_Valid_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0004"
    )
        port map (
