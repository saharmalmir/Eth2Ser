...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_RX_Without_Baud is
  ...
  attribute SOFT_HLUTNM of s_FrameEr_i_3 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \s_bit_count[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \s_shiftreg[7]_i_3\ : label is "soft_lutpair1";
begin
...
s_FrameEr_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => s_bit_count(0),
      I4 => s_FrameEr_i_3_n_0,
      I5 => i_Reset,
      O => s_FrameEr_i_1_n_0
    );
s_FrameEr_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
s_FrameEr_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"02"
    )
        port map (
