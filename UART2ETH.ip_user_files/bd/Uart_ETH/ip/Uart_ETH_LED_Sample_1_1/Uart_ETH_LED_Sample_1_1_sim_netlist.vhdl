...
-- Command     : write_vhdl -force -mode funcsim -rename_top Uart_ETH_LED_Sample_1_1 -prefix
--               Uart_ETH_LED_Sample_1_1_ Uart_ETH_LED_Sample_1_0_sim_netlist.vhdl
...
entity Uart_ETH_LED_Sample_1_1_LED_Sample is
  port (
...
end Uart_ETH_LED_Sample_1_1_LED_Sample;

architecture STRUCTURE of Uart_ETH_LED_Sample_1_1_LED_Sample is
  ...
  attribute SOFT_HLUTNM of \s_counter[7]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \s_counter[8]_i_1\ : label is "soft_lutpair3";
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Uart_ETH_LED_Sample_1_1 is
  port (
    i_CLK : in STD_LOGIC;
    i_Reset : in STD_LOGIC;
    i_Sample_Tick : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of Uart_ETH_LED_Sample_1_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Uart_ETH_LED_Sample_1_1 : entity is "Uart_ETH_LED_Sample_1_0,LED_Sample,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of Uart_ETH_LED_Sample_1_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of Uart_ETH_LED_Sample_1_1 : entity is "LED_Sample,Vivado 2017.2";
end Uart_ETH_LED_Sample_1_1;

architecture STRUCTURE of Uart_ETH_LED_Sample_1_1 is
begin
U0: entity work.Uart_ETH_LED_Sample_1_1_LED_Sample
     port map (
      i_CLK => i_CLK,
      i_Reset => i_Reset,
