...
HD_PWD='E:/ETH2SER/SoftwareProjects/UART2ETH970503_Master_Slave_IOBUF/UART2ETH.runs/Uart_ETH_xlslice_KeyPad_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Uart_ETH_xlslice_KeyPad_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Uart_ETH_xlslice_KeyPad_1.tcl
