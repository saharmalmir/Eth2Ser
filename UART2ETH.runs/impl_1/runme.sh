...
HD_PWD='E:/ETH2SER/SoftwareProjects/UART2ETH970507_Master_Slave_OK/UART2ETH.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Uart_ETH_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Uart_ETH_wrapper.tcl -notrace
