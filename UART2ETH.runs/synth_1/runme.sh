...
HD_PWD='E:/ETH2SER/SoftwareProjects/UART2ETH970507_Master_Slave_OK/UART2ETH.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Uart_ETH_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Uart_ETH_wrapper.tcl
