...
//	HAL_TIM_Base_Stop_IT(&htim2);
  ...
  Timer_struct[BufferIndex].Ticks			=	Ticks;
  Timer_struct[BufferIndex].Propotion	=	Propotion;
  Timer_struct[BufferIndex].F_Do				=	TRUE;
  Timer_struct[BufferIndex].F_Done			=	FALSE;
//  __set_interrupt_state(s);
//	/* Start Timer2 Interrupt */
//	HAL_TIM_Base_Start_IT(&htim2);
}
//*******************************************************************************************
void TMR_StopTimer(uint16_t BufferIndex , struct Timer_Var* Timer_struct)
{
//  __istate_t s = __get_interrupt_state(); __disable_interrupt();
//	/* Stop Timer2 Interrupt */
//	HAL_TIM_Base_Stop_IT(&htim2);
  
	Timer_struct[BufferIndex].F_Do				=	FALSE;
//  __set_interrupt_state(s);
//	/* Start Timer2 Interrupt */
//	HAL_TIM_Base_Start_IT(&htim2);
}
//*******************************************************************************************
void TMR_ReStartTimer(uint16_t BufferIndex , struct Timer_Var* Timer_struct)
{
// __istate_t s = __get_interrupt_state(); __disable_interrupt();
//	/* Stop Timer2 Interrupt */
//	HAL_TIM_Base_Stop_IT(&htim2);
...
//*******************************************************************************************
uint8_t TMR_IsTimerDone(uint16_t BufferIndex , struct Timer_Var* Timer_struct)
{
 return (Timer_struct[BufferIndex].F_Done);
}
//*******************************************************************************************
void TMR_ResetTimer(uint16_t BufferIndex , struct Timer_Var* Timer_struct)
{
//  __istate_t s = __get_interrupt_state(); __disable_interrupt();
//	/* Stop Timer2 Interrupt */
//	HAL_TIM_Base_Stop_IT(&htim2);
	
  Timer_struct[BufferIndex].Ticks			=	0;
  Timer_struct[BufferIndex].Propotion	=	0;
  Timer_struct[BufferIndex].F_Do				=	FALSE;
  Timer_struct[BufferIndex].F_Done			=	FALSE;
//  __set_interrupt_state(s);
//	/* Start Timer2 Interrupt */
