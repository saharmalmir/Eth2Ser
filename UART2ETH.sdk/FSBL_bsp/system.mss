...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = Axi_GPIOs_axi_gpio_LED
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = Axi_GPIOs_axi_gpio_SW
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = UART_Config_Register
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = UART_Config_Register_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = All_Data_Sender
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Uart_Blocks_All_Data_Sender_0
END
