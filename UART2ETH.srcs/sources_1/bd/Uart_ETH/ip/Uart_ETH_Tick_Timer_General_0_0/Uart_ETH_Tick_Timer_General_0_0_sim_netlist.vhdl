...
-- Command     : write_vhdl -force -mode funcsim -rename_top Uart_ETH_Tick_Timer_General_0_0 -prefix
--               Uart_ETH_Tick_Timer_General_0_0_ Uart_ETH_Tick_Timer_General_0_0_sim_netlist.vhdl
...
entity Uart_ETH_Tick_Timer_General_0_0_Tick_Timer_General is
  port (
...
end Uart_ETH_Tick_Timer_General_0_0_Tick_Timer_General;

architecture STRUCTURE of Uart_ETH_Tick_Timer_General_0_0_Tick_Timer_General is
...
\s_Tic_1ms0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => \s_Tic_1ms0_carry__0_i_1_n_0\,
      O(3 downto 0) => \NLW_s_Tic_1ms0_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3) => \s_Tic_1ms0_carry__0_i_2_n_0\,
      S(2) => \s_Tic_1ms0_carry__0_i_3_n_0\,
      S(1) => \s_Tic_1ms0_carry__0_i_4_n_0\,
      S(0) => \s_Tic_1ms0_carry__0_i_5_n_0\
    );
...
\s_Tic_1ms0_carry__0_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\s_Tic_1ms0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \s_Tic_1ms0_carry__1_i_1_n_0\,
      S(2) => \s_Tic_1ms0_carry__1_i_2_n_0\,
      S(1) => \s_Tic_1ms0_carry__1_i_3_n_0\,
      S(0) => \s_Tic_1ms0_carry__1_i_4_n_0\
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Uart_ETH_Tick_Timer_General_0_0 is
  port (
    i_Clk : in STD_LOGIC;
    i_Reset : in STD_LOGIC;
    o_Tic_1us : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of Uart_ETH_Tick_Timer_General_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Uart_ETH_Tick_Timer_General_0_0 : entity is "Uart_ETH_Tick_Timer_General_0_0,Tick_Timer_General,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of Uart_ETH_Tick_Timer_General_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of Uart_ETH_Tick_Timer_General_0_0 : entity is "Tick_Timer_General,Vivado 2017.2";
end Uart_ETH_Tick_Timer_General_0_0;

architecture STRUCTURE of Uart_ETH_Tick_Timer_General_0_0 is
begin
U0: entity work.Uart_ETH_Tick_Timer_General_0_0_Tick_Timer_General
     port map (
      i_Clk => i_Clk,
      i_Reset => i_Reset,
      o_Tic_1ms => o_Tic_1ms,
