...
entity All_Data_Sender_AXILiteS_s_axi is
generic (
...
end entity All_Data_Sender_AXILiteS_s_axi;
...
architecture behave of All_Data_Sender_AXILiteS_s_axi is
    ...
    component All_Data_Sender_AXILiteS_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component All_Data_Sender_AXILiteS_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_a
int_a : All_Data_Sender_AXILiteS_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 36,
     AWIDTH   => log2(36))
...
entity All_Data_Sender_AXILiteS_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity All_Data_Sender_AXILiteS_s_axi_ram;

architecture behave of All_Data_Sender_AXILiteS_s_axi_ram is
