...
entity UART_Config_Register_AXILiteS_s_axi is
generic (
...
end entity UART_Config_Register_AXILiteS_s_axi;
...
architecture behave of UART_Config_Register_AXILiteS_s_axi is
    type states is (wridle, wrdata, wrresp, wrreset, rdidle, rddata, rdreset);  -- read and write fsm states
    signal wstate  : states := wrreset;
    signal rstate  : states := rdreset;
    signal wnext, rnext: states;
    constant ADDR_A_BASE : INTEGER := 16#80#;
    constant ADDR_A_HIGH : INTEGER := 16#ff#;
    ...
    component UART_Config_Register_AXILiteS_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component UART_Config_Register_AXILiteS_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_a
int_a : UART_Config_Register_AXILiteS_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 32,
     AWIDTH   => log2(32))
...
entity UART_Config_Register_AXILiteS_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity UART_Config_Register_AXILiteS_s_axi_ram;

architecture behave of UART_Config_Register_AXILiteS_s_axi_ram is
