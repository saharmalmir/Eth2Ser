			...
			u16 UartIntrId)
{
	 ...
	 */
	if(UartDeviceId == UART_DEVICE_ID1){
	XUartNs550_SetHandler(UartInstancePtr, UartNs550IntrHandler1,
			  UartInstancePtr);
	}
	if(UartDeviceId == UART_DEVICE_ID2){
	XUartNs550_SetHandler(UartInstancePtr, UartNs550IntrHandler2,
			  UartInstancePtr);
	}
	if(UartDeviceId == UART_DEVICE_ID3){
	XUartNs550_SetHandler(UartInstancePtr, UartNs550IntrHandler3,
			  UartInstancePtr);
	}
	if(UartDeviceId == UART_DEVICE_ID4){
	XUartNs550_SetHandler(UartInstancePtr, UartNs550IntrHandler4,
			  UartInstancePtr);
	}
	if(UartDeviceId == UART_DEVICE_ID5){
	XUartNs550_SetHandler(UartInstancePtr, UartNs550IntrHandler5,
			  UartInstancePtr);
	}
	if(UartDeviceId == UART_DEVICE_ID6){
	XUartNs550_SetHandler(UartInstancePtr, UartNs550IntrHandler6,
			  UartInstancePtr);
	}
	if(UartDeviceId == UART_DEVICE_ID7){
	XUartNs550_SetHandler(UartInstancePtr, UartNs550IntrHandler7,
			  UartInstancePtr);
	}
	if(UartDeviceId == UART_DEVICE_ID8){
	XUartNs550_SetHandler(UartInstancePtr, UartNs550IntrHandler8,
			  UartInstancePtr);
	}
	if(UartDeviceId == UART_DEVICE_ID9){
	XUartNs550_SetHandler(UartInstancePtr, UartNs550IntrHandler9,
			  UartInstancePtr);
	}
	if(UartDeviceId == UART_DEVICE_ID10){
	XUartNs550_SetHandler(UartInstancePtr, UartNs550IntrHandler10,
			  UartInstancePtr);
	}
	if(UartDeviceId == UART_DEVICE_ID11){
	XUartNs550_SetHandler(UartInstancePtr, UartNs550IntrHandler11,
			  UartInstancePtr);
	}
	if(UartDeviceId == UART_DEVICE_ID12){
	XUartNs550_SetHandler(UartInstancePtr, UartNs550IntrHandler12,
			  UartInstancePtr);
	}
	if(UartDeviceId == UART_DEVICE_ID13){
	XUartNs550_SetHandler(UartInstancePtr, UartNs550IntrHandler13,
			  UartInstancePtr);
	}
	if(UartDeviceId == UART_DEVICE_ID14){
	XUartNs550_SetHandler(UartInstancePtr, UartNs550IntrHandler14,
			  UartInstancePtr);
	}
	if(UartDeviceId == UART_DEVICE_ID15){
	XUartNs550_SetHandler(UartInstancePtr, UartNs550IntrHandler15,
			  UartInstancePtr);
	}
	if(UartDeviceId == UART_DEVICE_ID16){
	XUartNs550_SetHandler(UartInstancePtr, UartNs550IntrHandler16,
			  UartInstancePtr);
	}
	if(UartDeviceId == UART_DEVICE_ID_Config){
